...
links_dict[link1] = Result(link1, parser, '"No training configuration found in the save file"')
...
links_dict[link2] = Result(link2, parser, 'Problem with idenprof!')
thread2 = links_dict[link2].get_thread()

link3 = 'https://github.com/The-Kor/www/issues/41'
parser = get_parser_of_link(link3, parsers)
links_dict[link3] = Result(link3, parser, 'Permanently delete parser_factory')
